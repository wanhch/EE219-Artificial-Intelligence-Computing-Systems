...
class MNIST_MLP(object):
    ...
    def load_data(self):
        ...
        # 阅读load_mnist函数并参考train_images方式进行数据读取
    ...
    def shuffle_data(self):
        # Stochastic gradient descent的实现
...
def build_mnist_mlp(loss_dir='./stu_upload/loss.npy'):
    h1, h2, e = 100, 100, 10
    ...
    mlp.save_model('./stu_upload/mlp-%d-%d-%d-epoch.npy' % (h1, h2, e))
